...
{
	$sql2="UPDATE five_project set pname='$pname',pdomain='$pdomain' where usn1='$usn1' and usn2='$usn2'";
	if($conn->query($sql2)===TRUE)
	{
		...
		$sql5="UPDATE five_project set faculty='$id' where usn1='$usn1' and usn2='$usn2'";
		$conn->query($sql5);
